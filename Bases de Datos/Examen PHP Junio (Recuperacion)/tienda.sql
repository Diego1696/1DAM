...
--
-- Servidor: localhost
-- Tiempo de generación: 31-05-2017 a las 13:17:21
...
(38, '1h', 'LOGIN', '2017-05-31 10:49:19'),
(39, '2e', 'LOGIN', '2017-05-31 10:49:19'),
(40, 'admin', 'LOGIN', '2017-05-31 10:49:19'),
(41, 'alumno', 'LOGIN', '2017-05-31 10:49:19'),
(42, '1h', 'LOGIN', '2017-05-31 10:56:37'),
(43, '1h', 'LOGIN', '2017-05-31 11:58:45'),
(44, 'admin', 'LOGIN', '2017-05-31 12:09:48'),
(45, '1h', 'LOGIN', '2017-05-31 12:11:41'),
(46, 'admin', 'LOGIN', '2017-05-31 12:11:50'),
(47, '1h', 'LOGIN', '2017-05-31 12:19:10'),
(48, 'admin', 'LOGIN', '2017-05-31 12:19:18'),
(49, 'admin', 'LOGIN', '2017-05-31 12:35:46'),
(50, '1hasdfasdf', 'ALTA', '2017-05-31 13:01:46'),
(51, 'admin', 'LOGIN', '2017-05-31 13:09:05');
...
(80, '1h', 6, '2017-05-31', '1'),
(81, '1h', 6, '2017-05-31', '1'),
(82, '1h', 5, '2017-05-31', '1');
...
(4, 'Asus VS197D', 89, 'Dos cámaras, para FaceTime y grabación de vídeo en HD. Chip A5 dual-core, autonomía de 10 horas, iCloud y más de 200 prestaciones de software nuevas en iOS 5.', './pic/productos/informatica/Asus_VS197D.png', 1, 1, 10, 1),
(5, 'BQ Kepler', 179, 'El nuevo netbook Acer Aspire One 722 presenta un diseño moderno en diferentes colores que te cautivará. Cuenta con la mejor tecnología de procesador AMD Fusion y viene equipado con un disco duro interno de 320Gb', './pic/productos/informatica/BQ_Kepler.png', 1, 1, 30, 2),
...
(9, 'Philips 228C3LHSB/00', 174, 'Las mejores prestaciones con el mejor diseño. Acabados en blanco y pantalla super brillante para disfrutar de su procesador Intel Core i7.', './pic/productos/informatica/Philips_228C3LHSB-00.png', 1, 1, 100, 1),
...
(11, 'Blackberry 9360', 299, '. El nuevo smartphone BlackBerry Curve ofrece la clásica experiencia Blackberry, con su famoso teclado Blackberry que incluye un preciso trackpadóptico y el nuevo y avanzado, aunque fácil de usar, sistema operativo Blackberry 7.', './pic/1.png', 0, 3, 100, 1),
(12, 'Motorola D403 Trio', 39, 'Motorola Dispone de Manos libres, Pantalla retroiluminada, 50 memorias alfanuméricas, identificación de llamada, Intercomunicador, modo ECO reduce el consumo del terminal y melodias polifónicas.', './pic/1.png', 0, 3, 100, 1),
...
(15, 'LG M2780D', 329, 'Este televisor es una fusión de diseño y tecnología; extremadamente fino en diseño y más ecológico.\r\n\r\nAhora podrás disfrutar de la TDT en alta definición desde tu TV monitor y sintonizar los canales de tu proveedor de cable.', './pic/1.png', 0, 3, 100, 4),
...
(18, 'Samsung UE37D5000', 479, 'Los televisores LED de Samsung ofrecen una calidad de imagen insuperable gracias a su reproducción de colores más naturales y negros más intensos.', './pic/1.png', 0, 3, 100, 1),
...
(22, 'Logi\r\nLogitech Gaga blanco\r\n\r\nLogitech Gaga blanco', 79, 'Hagas lo que hagas con el teléfono Smartphone o la tablet, donde sea, hazlo a todo volumen. Este altavoz se empareja fácilmente con teléfonos Smartphone', './pic/1.png', 0, 5, 100, 1),
(23, 'Samsung Galaxy YP-G50 XW EDC', 89, 'El Samsung Galaxy YP-G50CW es capaz de ofrecerte la mejor calidad multimedia. Una experiencia multimedia rápida y divertida que saca el máximo partido al sistema operativo Android.', './pic/1.png', 0, 5, 100, 2),
(24, 'Sennheiser HD 228 blanco', 34, 'Luce una imagen más moderna y elegante con los nuevos auriculares HD 228 que te proporcionan una excelente reproducción de graves, un cómodo ajuste y una gran facilidad de uso gracias a su cable de un solo lado.', './pic/1.png', 0, 5, 70, 6),
...
('1h', '1h', 'Usuario 1H', '1h@salesianos.edu', '976306878', '2017-05-31 12:19:10', 1),
('1hasdfasdf', 'afb643c4c6', 'dfsgsd', 'sdfg@sd', 'asdf', '0000-00-00 00:00:00', 0),
('2e', '2e', '2e', 'dan@yfdfytfc.com', '90u8097980798', '2017-05-27 10:56:36', 1),
('admin', 'admin', 'Administrador Servicios', 'admin@gmail.com', '666123456', '2017-05-31 13:09:05', 1),
('alumno', 'alumno', 'Alumno Informática', 'alumno@salesianos.edu', '976306878', '2017-05-27 10:38:17', 1);

--
-- Disparadores `usuarios`
--
DROP TRIGGER IF EXISTS `controlAccesos`;
DELIMITER //
CREATE TRIGGER `controlAccesos` AFTER INSERT ON `usuarios`
 FOR EACH ROW begin
