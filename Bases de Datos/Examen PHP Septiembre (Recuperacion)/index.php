			...
			<form id="datos" action="" method="POST" class="cleanForm">
				...
				<fieldset>
					...
					<div class="distanceLeft">
						...
						<a href="reset.php" onclick="ejecutar('borrar')">Borrar Usuario</a>
					</div>
		...
		<div id="signUp" class="clearfix toggleTab">
			...
			<form action="registrar.php" method="POST" class="cleanForm" id="signUpForm">
				...
				<fieldset>
					...
					<p>
					    <label>Ciudad: <span class="requiredField">*</span></label>
					      <select name="idciudad" id="idciudad">
					        <option value=""></option>
					          ...
					          echo "<option value='$linea[idciudad]'>$linea[ciudad]";
					          }
					          ?>
					      </select>
					</p>
