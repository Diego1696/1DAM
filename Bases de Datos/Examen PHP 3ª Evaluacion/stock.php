...
?>
	...
	<!-- parte central -->               
        <div id="main_content">
                ...
                <div id="breadCrumb3" class="breadCrumb module">
					<select name="fecha" id="fecha" onchange="cargar(this.value)">
					     <option value='no' selected>Elige filtro
					     	<option value='1' >Menos de 10
					     	<option value='2' >Entre 10 y 50
					     	<option value='3' >Entre 50 y 100
					     	<option value='4' >Entre 100 y 200
					     	<option value='5' >Mas de 200
			...
			<table>
			<thead><tr><td>Imagen</td><td>Precio</td><td>Nombre de la categoria</td><td>Bandera </td><td>Unidades</td></tr></thead>
			<?php
			if(!isset($_GET['fil'])){
...
while($linea=mysql_fetch_array($registros)){
  ...
  echo"<tr><td><img width='50' src='$linea[imagen]'></td><td>$linea[precio]</td><td>$categoria[nombre]</td><td><img width='50' src='$bandera[bandera]'></td><td>$linea[unidades]</td></tr>";
}
?>
