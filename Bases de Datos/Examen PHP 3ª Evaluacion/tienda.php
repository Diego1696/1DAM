...
{
	$cat=$_GET['cat'];
	$sql="SELECT * FROM productos as po, paises as pa WHERE po.idpais=pa.idpais and idCategoria=$cat";
}
else
{
	$sql="SELECT * FROM productos as po, paises as pa WHERE po.idpais=pa.idpais and mostrar=1";
}
$registros=mysql_query($sql);
while($linea=mysql_fetch_array($registros))
{
	if($_SESSION['usuario']=='invitado'){
		echo"<div class='product'><img src='$linea[imagen]' width ='172'><div class='text'><p class='product_title'>$linea[nombre]</p><p class='price'>$linea[precio]</p><div class='buy'><img src='$linea[bandera]' width='25'></div></div></div>";}
	else{
		echo"<div class='product'><img src='$linea[imagen]' width ='172'><div class='text'><p class='product_title'>$linea[nombre]</p><p class='price'>$linea[precio]</p><div class='buy'><img src='$linea[bandera]' width='25'>&nbsp;<a href='altasCarrito.php?ref=$linea[idProducto]'><img src='./img/cart_add.png'></a></div></div></div>";
	}
}
?>			
